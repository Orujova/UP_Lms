...
import { Users, Search, Check, X, ChevronRight, Award, Calendar, Clock, Settings, Target } from "lucide-react";
import {
  setFormData,
  prevStep,
  createCourseAsync,
...
const TargetGroupsStep = ({ onBack, onSave, isSubmitting }) => {
  ...
  const loadCertificates = async () => {
    try {
      setCertificates([
        { id: 1, name: "Certificate of Completion", type: "Basic" },
        { id: 2, name: "Certificate of Excellence", type: "Premium" },
        { id: 3, name: "Certificate of Mastery", type: "Advanced" },
      ]);
    } catch (error) {
            ...
            <div className="p-4 border-b border-gray-200">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-base font-semibold text-gray-900 flex items-center">
                  <Target className="w-4 h-4 mr-2 text-[#0AAC9E]" />
            ...
            <div className="p-4 max-h-80 overflow-y-auto">
              {filteredGroups.length === 0 ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-sm text-gray-500">No target groups found</p>
                </div>
              ) : (
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <h3 className="text-base font-semibold text-gray-900 mb-3 flex items-center">
              <Users className="w-4 h-4 mr-2 text-[#0AAC9E]" />
              Assignment Summary
            </h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-2 bg-[#0AAC9E]/5 rounded-lg">
                ...
                <span className="text-base font-bold text-[#0AAC9E]">
              ...
              {formData.verifiedCertificate && (
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-2 py-1.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0AAC9E] focus:border-[#0AAC9E] text-xs"
                  >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <h3 className="text-base font-semibold text-gray-900 mb-3 flex items-center">
              <Settings className="w-4 h-4 mr-2 text-[#0AAC9E]" />
              Advanced Settings
            </h3>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="relative">
                  <Clock className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-400 w-3 h-3" />
                  <input
                    type="number"
          ...
          {/* Course Summary */}
          <div className="bg-[#0AAC9E]/5 rounded-xl border border-[#0AAC9E]/20 p-4">
            <h3 className="text-base font-semibold text-[#0AAC9E] mb-3">
              Course Summary
            </h3>
      ...
      <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-200">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="px-6 py-2 bg-[#0AAC9E] text-white rounded-lg hover:bg-[#0AAC9E]/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium text-sm"
          >
            {isSubmitting ? (
              <div className="flex items-center space-x-2">
