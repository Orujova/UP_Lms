  ...
  async function submitCredential(e) {
    ...
    const response = await fetch(process.env.NEXT_PUBLIC_USER_API, {
      ...
      headers: {
        ...
        'Authorization': 'Bearer eyJhbGciOiJodHRwOi8vd3d3LnczLm9yZy8yMDAxLzA0L3htbGRzaWctbW9yZSNobWFjLXNoYTI1NiIsInR5cCI6IkpXVCJ9..OIsHL8bGXDvZfKk1cfi3zOrxZ9HkJXAo3WcL5F233nY'
    },
    ...
    <main className="bg-login1 w-fully h-fully bg-no-repeat">
      <div className="w-fully h-fully flex items-center justify-end box">
        <div className="w-40 ml-auto max-w-[420px]">
          <h1 className="text-center text-34 font-semibold py-14">LOGO</h1>
            ...
            {otp ? (
              <>
                ...
                <div className="text-16">
                  ...
                  <span>+994(55) 254-65-13 </span>
                </div>
                <div className="flex gap-5">
                  <input
                    type="text"
                    className="bg-mainGreen py-7 rounded-8 text-center font-bold text-white"
                  />
                  <input
                    type="text"
                    className="bg-mainGreen py-7 rounded-8 text-center font-bold text-white"
                ...
                <button className="w-full bg-black text-white rounded-16 py-4">
                  Verify
                </button>
                <div className="text-14 text-center w-full">
                  Didn’t received code?{" "}
                  <span className="text-mainBlue cursor-pointer">Resend</span>
                </div>
              </>
            ) : (
              <>
                ...
                >
                  ...
                  <div className="flex flex-col items-start gap-3 w-full">
                    ...
                    <button className="w-full bg-black text-white rounded-16 py-4 mt-4">
                      Log in
                    </button>
                  </div>
                </form>
