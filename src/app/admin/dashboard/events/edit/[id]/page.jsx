...
const EditEventForm = ({ params }) => {
  ...
  useEffect(() => {
    const calculateProgress = () => {
      ...
      if (formData.imageFile || imagePreview) progress += 1;
      ...
      try {
        ...
        setFormData((prev) => ({
          ...
          targetGroupIds: Array.isArray(data.targetGroupIds)
            ...
            : [],
          eventId: id,
          requirements: Array.isArray(data.eventRequirements)
      ...
      <div>
        <div className="flex items-center justify-between mb-6 border-b border-gray-200 pb-3">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-semibold text-gray-800">Edit Event</h1>
          </div>
          <button
